...
2. Discover relevant CI/CD actions.
   - Inspect workflow definitions and repo-specific scripts.
...
Also summarize any actions that remained blocked, skipped, or only partially verified.
